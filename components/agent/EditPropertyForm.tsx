...
import { useUpdateProperty } from '@/hooks/useAgent'
...
export default function EditPropertyForm({ property, onClose }: { property: any; onClose: () => void }) {
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 max-w-2xl w-full mx-4 my-8">
        ...
        <form onSubmit={handleSubmit(data => {
          mutation.mutate({ id: property.id, data: data as any }, {
            onSuccess: () => onClose()
          })
          ...
          <input {...register('property_type')} placeholder="Type" className="px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-500" />
          ...
          <textarea {...register('amenities')} rows={2} placeholder="Amenities" className="md:col-span-2 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-500" />
